...
public class CreateTableAutomaticGrant {
  private Map<String, List<PrivilegeGrantInfo>> userGrants;//每一个user有哪些权限
  private Map<String, List<PrivilegeGrantInfo>> groupGrants;//每一个组有哪些权限
  private Map<String, List<PrivilegeGrantInfo>> roleGrants;//每一个角色有哪些权限
  ...
  public static CreateTableAutomaticGrant create(HiveConf conf)
    ...
    /**
     *
     * @param grantMapStr user,user,user;
     * @return
     * @throws HiveException
     */
